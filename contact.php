...
then we will use concatenation to construct our email body using the inputted variables*/
    ...
    if(isset($_POST['email']) && $_POST['email'] !=''){
        ...
        if(filter_var($_POST['email'], FILTER_VALIDATE_EMAIL)){
            ...
            $body .= "Number of Lessons" .$lessons. "\r\n";
...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-dark navbar-dark">
        ...
        <div class="container-fluid">
            ...
            <a href="index.html" class="navbar-brand"><img src = "https://ik.imagekit.io/eccktgb8fra/Copy_of_Copy_of_DASH_DOtphMBdd.png" alt ="sandys logo"></a>
            ...
            <div class="collapse navbar-collapse" id = "navmenu">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item px-2">
                        <a href="prices-1.html" class="navbar-link text-light text-decoration-none"><b>Prices and Services</b></a>
                    </li>
                    <li class ="nav-item px-2">
                    ...
                    <li class = "nav-item px-2">
                        <a href="instructor-training.html" class="navbar-link text-light text-decoration-none"><b>Instructor Training</b></a>
                    </li>
...
<!--here we tell the browser to load the specific image dependant on the viewport-->            
            <img class = "img-fluid" src = "https://ik.imagekit.io/eccktgb8fra/undraw_manage_chats_ylx0_up0CoRlfVl.png"
                srcset ="https://ik.imagekit.io/eccktgb8fra/undraw_manage_chats_ylx0_up0CoRlfVl.png?tr:w-500 500w,
                https://ik.imagekit.io/eccktgb8fra/undraw_manage_chats_ylx0_up0CoRlfVl.png?tr:w-800 800w,
                https://ik.imagekit.io/eccktgb8fra/undraw_manage_chats_ylx0_up0CoRlfVl.png?tr:w-1024 900w">
...
<!--we utilise the container with the error class to be able to provide an individual message for each field an error may occur-->
    <div class = "container">
        <form id = "contact-form" method = "post" action = "contact.php" role = "form" class = "row g-3">
            ...
            <div class = "col-md-12">
                <select id = "lesson_no" name = "No_of_lessons" class = "form-control" required = "required" data-error = "Please select which block of lessons you wish to enquire about!">
                    <option value = ""></option>
                    <option value = "10 Lessons">10 lessons</option>
                    <option value = "15 lessons">15 Lessons</option>
                    <option value = "20 Lessons">20 Lessons</option>
                    <option value = "25 Lessons">25 Lessons</option>
                    <option value = "30 Lessons">30 Lessons</option>
                    <option value = "35 Lessons">35 Lessons</option>
                    <option value = "35 Lessons"> 40 Lessons </option>
                </select>
...
if($messagesent == True):
    ...
    echo '<img src = "img/full-inbox.png" alt ="Doggy Driver">';       
    ...
    <section>
        <div class ="container-fluid bg-dark">
            <div class = "row align-items-center justify-content-between">
                ...
                <div class ="col-md">
                    <img class = "img-fluid w-50 d-md-block" src = "img/Untitled design.png" alt ="Certificates">
                </div>
            </div>
        </div>
    </section>
